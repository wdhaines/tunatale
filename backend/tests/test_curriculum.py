...
class TestPromptBuilder:
    """Tests for PromptBuilder: topic, language, CEFR level, JSON instruction."""

    def test_prompt_includes_topic(self, prompt_builder, language):
    ...
    def test_prompt_includes_language_name(self, prompt_builder, language):
        prompt = prompt_builder.build_curriculum_prompt(
            topic="coffee",
            language=language,
            cefr_level="A2",
    ...
    def test_prompt_includes_cefr_level(self, prompt_builder, language):
        prompt = prompt_builder.build_curriculum_prompt(
            topic="coffee",
            language=language,
            cefr_level="B1",
    ...
    def test_prompt_includes_json_instruction(self, prompt_builder, language):
        prompt = prompt_builder.build_curriculum_prompt(
            topic="coffee",
            language=language,
            cefr_level="A2",
    ...
    def test_system_prompt_mentions_slovene(self, prompt_builder, language):
...
class TestCurriculumGenerator:
    """Tests for CurriculumGenerator: output structure, error handling."""

    async def test_generate_returns_curriculum(self, generator, language):
    ...
    async def test_generate_curriculum_has_correct_num_days(self, generator, language):
        curriculum = await generator.generate(
            topic="ordering coffee in Ljubljana",
            language=language,
            cefr_level="A2",
    ...
    async def test_generate_curriculum_days_have_collocations(self, generator, language):
        curriculum = await generator.generate(
            topic="coffee",
            language=language,
            cefr_level="A2",
    ...
    async def test_generate_curriculum_has_learning_objectives(self, generator, language):
        curriculum = await generator.generate(
            topic="coffee",
            language=language,
            cefr_level="A2",
    ...
    async def test_generate_handles_invalid_json_gracefully(self, language):
    ...
    async def test_generate_curriculum_language_code_set(self, generator, language):
        curriculum = await generator.generate(
            topic="coffee",
            language=language,
            cefr_level="A2",
    ...
    async def test_generate_curriculum_topic_stored(self, generator, language):
        curriculum = await generator.generate(
