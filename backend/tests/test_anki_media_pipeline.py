"""Tests for S3.8: media pipeline orchestration."""
...
def _make_fakes(
    *,
    ...
    pixabay_returns: tuple[bytes, str] | None = None,
    ...
    def fake_pixabay(english, *, api_key, http_client=None):
...
class TestFetchCardMedia:
    ...
    async def test_includes_pixabay_image(self):
        forvo_fn, tts_fn, pix_fn, norm_fn = _make_fakes(
            ...
            pixabay_returns=(b"img_data", "jpg"),
        )
