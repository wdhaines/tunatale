<script lang="ts">
	...
	// No cloze-rewrite control here, deliberately (tunatale-keb0). It lives in
	// the Cards viewer, reachable from the "Card details ↗" link beside this
	// card: rewriting a sentence is card MAINTENANCE, and a maintenance action
	// on the answer side of a card you are mid-way through grading invites a
	// click you did not mean — which is what made a one-click rewrite feel like
	// a gamble.
