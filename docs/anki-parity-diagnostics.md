...
| `clear_session_main_queue` + `build_and_freeze_main_queue` | `app/srs/anki_mirror/queue_stats.py` + `app/srs/anki_mirror/queue_engine.py` | Session-queue cache management (Layers 4, 7, 29). |
